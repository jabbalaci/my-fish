...
### (21) joinlines: Join the input lines with a separator
...
### (22) justify: Fully justify text to `<width>` [default: 78]
...
### (24) longest: Length of the longest line
...
### (26) mirror: Mirror text using mirrored Unicode characters
...
### (27) mixup: Mix up inner letters of each word, keeping first/last intact
...
### (28) morse: Convert text to Morse code [e.g., 'SOS' -> '... --- ...']
...
### (29) noaccents: Remove accents [á -> a, etc.]
...
### (30) nonempty: Remove empty lines
...
### (31) obfuscate: Replace letters with similar-looking symbols [e -> 3, a -> @, etc.]
...
### (32) oct: Decimal number to octal
...
### (33) p.allext: Path [/usr/lib/a.tar.gz -> .tar.gz]
...
### (34) p.ext: Path [/usr/lib/a.tar.gz -> .gz]
...
### (35) p.fname: Path [/usr/lib/stuff.tar.gz -> stuff]
...
### (36) p.name: Path [/usr/lib/python2.5/gopherlib.py -> gopherlib.py]
...
### (37) p.parent: Path [/usr/lib/python2.5/gopherlib.py -> /usr/lib/python2.5]
...
### (38) p.stem: Path [/usr/lib/python2.5/gopherlib.py -> gopherlib]
...
### (39) prettyjson: Pretty-print JSON
...
### (40) prettynum: Prettify a number
...
### (41) qrcode: Generate a QR code from text [ANSI]
...
### (42) qrcode2: Generate a QR code from text [PNG]
...
### (43) quote: Create GET-style quoted text
...
### (44) quotes: Add quotes around the input
...
### (45) randomcase: Alternate case randomly
...
### (46) randomline: Select a non-empty random line from input
...
### (49) repeat: Repeat a text `<n>` times
...
### (50) replace: Replace `<old>` with `<new>`
...
### (52) roman: Convert number to Roman numeral [1-3999]
...
### (53) rot: Rotate letters with with `<n>` positions
...
### (54) shuffle: Shuffle characters in each line
...
### (55) sparkline: Generate sparkline chart from numbers
...
### (56) swapcase: Swap lower- and uppercase
...
### (57) take: Take the first `<n>` lines of stdin
...
### (58) tiny: Convert text to tiny superscript letters
...
### (59) title: Convert to title case
...
### (60) trim: Trim leading/trailing whitespace
...
### (61) typewriter: Print like a typewriter
...
### (62) typewriter2: Print like a typewriter with sound effects
...
### (63) unbin: Binary number to decimal
...
### (64) unflip: Revert upside-down Unicode text back to normal
...
### (65) unhex: Hex number to decimal
...
### (66) unmirror: Convert mirrored text back to normal
...
### (67) unmorse: Convert Morse code to text [e.g., '... --- ...' -> 'SOS']
...
### (68) unoct: Octal number to decimal
...
### (69) unquote: Decode GET-style quoted text
...
### (70) unroman: Convert Roman numeral to number
...
### (71) untiny: Convert tiny superscript letters back to normal text [not perfect]
...
### (72) unutf8: Decode the input with UTF-8
...
### (76) utf8: Encode the input with UTF-8
...
### (77) whitespaces: Show whitespaces
...
### (79) zalgo1: Add funny accents to characters [a -> ấ, etc.]
...
### (80) zalgo2: Add random Unicode glitches to text
...
### (81) zalgo3: Add Zalgo (glitchy) characters
...
### (7) char: Detailed information about a character
...
### (9) dname: Print just the current directory name
...
### (10) dos-greeting: Classical DOS starting screen
...
### (11) dos-prompt: Activate the DOS prompt
...
### (13) edit2: Edit two files side by side
...
### (14) edits: Print editing possibilities
...
### (16) efs: Edit the given function's corresponding script
...
### (17) epair: Edit the given function and its pair (ex.: hex and unhex)
...
### (18) ex: Universal archive extractor
...
### (20) find_conflicted_copies: Find conflicted copies in your Dropbox folder
...
### (21) fish_command_not_found: Ubuntu-like suggestion when a command is not found
...
### (22) fish_greeting: Default greeting message
...
### (24) function-descriptions: Functions and their descriptions
...
### (25) get-function-description: Print the description of a function
...
### (26) gitup: Upload local changes to the git repo
...
### (27) good_shape_manjaro: Update the list of mirror servers, find the fastest ones
...
### (30) isodate: Print date in YYYY-MM-DD format
...
### (31) isodatetime: Print timestamp in YYYY-MM-DDTHH:MM:SS format
...
### (32) jive: Start the JiVE image viewer
...
### (33) json: Print key/value pairs in a JSON file
...
### (35) machine_id: Print the machine ID
...
### (36) mc: Launch Midnight Commander and stay in the folder where you quit
...
### (37) mdgo: Make directory and cd into it
...
### (38) minimal-prompt: A minimal prompt
...
### (39) moodle-link: Put a link on the given URL without embedding it | Moodle
...
### (40) moodle-nolink: Insert a URL as text, without putting a link on it | Moodle
...
### (41) myalias: Similar to the alias in bash
...
### (42) no-autosuggestions: Disable autosuggestions
...
### (43) no-theme: Select the None theme (no colors)
...
### (44) private-mode: Start private mode, history will not be persisted
...
### (45) pyloc: Count Python lines of code (excluding .venv)
...
### (46) python3clean: Start the Python 3 REPL without the extra info line
...
### (48) r: Run a source code (compile and run)
...
### (49) random-functions: Some random functions (so that you don't forget them)
...
### (50) re: Wake up the Dropbox client
...
### (51) ren: Rename a file interactively
...
### (52) resolution: Current resolution
...
### (54) skip: Skip the first `<n>` lines of stdin
...
### (55) sp: Show the current path or show the path of a given file
...
### (56) unixtime: Print the Unix epoch time
...
### (57) unixtime2date: Convert Unix epoch time to normal date
...
### (58) upgrade_pipx_and_uv: Upgrade packages installed with pipx and uv
...
### (60) uv_venv: Call the `uv_venv` script
...
### (61) xfce-info: Current XFCE version
...
### (62) xrates: Currency rates of HUF, EUR and USD
...
### (63) y: Start yazi (and stay in the folder where you quit)
