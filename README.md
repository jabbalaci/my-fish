...
### (26) isascii: Check if a text is ASCII only

[isascii.fish](functions/isascii.fish)
...
### (27) joinlines: Join the input lines with a separator
...
### (28) justify: Fully justify text to `<width>` [default: 78]
...
### (30) longest: Length of the longest line
...
### (32) max: Find the largest element [default type: int]
...
### (33) min: Find the smallest element [default type: int]
...
### (34) mirror: Mirror text using mirrored Unicode characters
...
### (35) mixup: Mix up inner letters of each word, keeping first/last intact
...
### (36) morse: Convert text to Morse code [e.g., 'SOS' -> '... --- ...']
...
### (37) noaccents: Remove accents [á -> a, etc.]
...
### (38) nonempty: Remove empty lines
...
### (39) obfuscate: Replace letters with similar-looking symbols [e -> 3, a -> @, etc.]
...
### (40) oct: Decimal number to octal
...
### (41) p.allext: Path [/usr/lib/a.tar.gz -> .tar.gz]
...
### (42) p.ext: Path [/usr/lib/a.tar.gz -> .gz]
...
### (43) p.fname: Path [/usr/lib/stuff.tar.gz -> stuff]
...
### (44) p.name: Path [/usr/lib/python2.5/gopherlib.py -> gopherlib.py]
...
### (45) p.parent: Path [/usr/lib/python2.5/gopherlib.py -> /usr/lib/python2.5]
...
### (46) p.stem: Path [/usr/lib/python2.5/gopherlib.py -> gopherlib]
...
### (47) prettyjson: Pretty-print JSON
...
### (48) prettynum: Prettify a number
...
### (49) prod: Product of the values in the input
...
### (50) qrcode: Generate a QR code from text [ANSI]
...
### (51) qrcode2: Generate a QR code from text [PNG]
...
### (52) quote: Create GET-style quoted text
...
### (53) quotes: Add quotes around the input
...
### (54) randomcase: Alternate case randomly
...
### (55) randomline: Select a non-empty random line from input
...
### (58) repeat: Repeat a text `<n>` times
...
### (59) replace: Replace `<old>` with `<new>`
...
### (61) roman: Convert number to Roman numeral [1-3999]
...
### (62) rot: Rotate letters with with `<n>` positions
...
### (63) shuffle: Shuffle characters in each line
...
### (64) skip: Skip the first `<n>` lines of stdin, or skip the last line if `last` is provided
...
### (65) sparkline: Generate sparkline chart from numbers
...
### (66) sum: Sum of the values in the input
...
### (67) swapcase: Swap lower- and uppercase
...
### (68) take: Take the first `<n>` lines of stdin, or take the last line if `last` is provided
...
### (69) tiny: Convert text to tiny superscript letters
...
### (70) title: Convert to title case
...
### (71) trim: Trim leading/trailing whitespace
...
### (72) typewriter: Print like a typewriter
...
### (73) typewriter2: Print like a typewriter with sound effects
...
### (74) unbin: Binary number to decimal
...
### (75) unflip: Revert upside-down Unicode text back to normal
...
### (76) unhex: Hex number to decimal
...
### (77) uniq_keep_order: Remove duplicated lines and keep the order
...
### (78) unmirror: Convert mirrored text back to normal
...
### (79) unmorse: Convert Morse code to text [e.g., '... --- ...' -> 'SOS']
...
### (80) unoct: Octal number to decimal
...
### (81) unquote: Decode GET-style quoted text
...
### (82) unroman: Convert Roman numeral to number
...
### (83) untiny: Convert tiny superscript letters back to normal text [not perfect]
...
### (84) unutf8: Decode the input with UTF-8
...
### (88) utf8: Encode the input with UTF-8
...
### (89) whitespaces: Show whitespaces
...
### (91) words: Split input into words
...
### (92) zalgo1: Add funny accents to characters [a -> ấ, etc.]
...
### (93) zalgo2: Add random Unicode glitches to text
...
### (94) zalgo3: Add Zalgo (glitchy) characters
...
### (1) addnimbang: Add nimbang header to the file

[addnimbang.fish](functions/addnimbang.fish)
...
### (2) alphabet: Print the alphabet (lowercase, uppercase, digits, printable characters)
...
### (3) aur: Find package in the AUR repository
...
### (4) awk-info: Basic usage of the awk command
...
### (7) binds: Some useful keyboard bindings in Fish
...
### (8) bing: Extract the URL of the wallpaper image on bing.com
...
### (9) bm: Bookmark a file (for copy/paste)
...
### (10) c: Compile a source code

[c.fish](functions/c.fish)
...
### (11) char: Detailed information about a character
...
### (12) cop: Copy a file interactively
...
### (15) cut-info: Basic usage of the cut command
...
### (16) dname: Print just the current directory name
...
### (17) dos-greeting: Classical DOS starting screen
...
### (18) dos-prompt: Activate the DOS prompt
...
### (19) edit2: Edit two files side by side
...
### (20) edits: Print editing possibilities
...
### (22) efs: Edit the given function's corresponding script
...
### (23) epair: Edit the given function and its pair (ex.: hex and unhex)
...
### (24) ex: Universal archive extractor
...
### (25) exit_code: Produce the given exit code
...
### (26) feh-slideshow: Start a slideshow with feh
...
### (28) find_conflicted_copies: Find conflicted copies in your Dropbox folder
...
### (29) fish_command_not_found: Ubuntu-like suggestion when a command is not found
...
### (30) fish_greeting: Default greeting message
...
### (32) function-descriptions: Functions and their descriptions
...
### (33) get-function-description: Print the description of a function
...
### (34) gitup: Upload local changes to the git repo
...
### (35) good_shape_manjaro: Update the list of mirror servers, find the fastest ones
...
### (38) isodate: Print date in YYYY-MM-DD format
...
### (39) isodatetime: Print timestamp in YYYY-MM-DDTHH:MM:SS format
...
### (40) jive: Start the JiVE image viewer
...
### (41) jl: *j*ump to a previously (*l*ast) visited dir.

[jl.fish](functions/jl.fish)
...
### (42) json: Print key/value pairs in a JSON file
...
### (44) lscd_wrapper: Wrapper script for lscd

[lscd_wrapper.fish](functions/lscd_wrapper.fish)
...
### (45) machine_id: Print the machine ID
...
### (46) malap: Multi alap, i.e. call my program `alap` with each argument
...
### (47) mc: Launch Midnight Commander and stay in the folder where you quit
...
### (48) mcu: Launch Midnight Commander without a subshell and stay in the folder where you quit

[mcu.fish](functions/mcu.fish)
...
### (49) mdgo: Make directory and cd into it
...
### (51) minimal-prompt: A minimal prompt
...
### (52) moodle-link: Put a link on the given URL without embedding it | Moodle
...
### (53) moodle-nolink: Insert a URL as text, without putting a link on it | Moodle
...
### (54) myalias: Similar to the alias in bash
...
### (55) no-autosuggestions: Disable autosuggestions
...
### (56) no-theme: Select the None theme (no colors)
...
### (57) printable: Make a PDF file printable

[printable.fish](functions/printable.fish)
...
### (58) private-mode: Start private mode, history will not be persisted
...
### (59) pyeval: Evaluate an expression with Python
...
### (60) pyloc: Count Python lines of code (excluding .venv)
...
### (61) python3clean: Start the Python 3 REPL without the extra info line
...
### (63) r: Run a source code (compile and run)
...
### (64) random-functions: Some random functions (so that you don't forget them)
...
### (65) re: Wake up the Dropbox client
...
### (66) ren: Rename a file interactively
...
### (67) repo: Open the GitHub URL of the current project
...
### (68) resolution: Current resolution
...
### (70) sort-info: Basic usage of the sort command
...
### (71) sp: Show the current path or show the path of a given file
...
### (72) subreddit: Number of subscribers of a subreddit
...
### (73) timezones: List of valid timezones
...
### (74) top10dirs: Top 10 largest directories
...
### (75) top10files: Top 10 largest files
...
### (76) tr-info: Basic usage of the tr command
...
### (77) unixtime: Print the Unix epoch time
...
### (78) unixtime2date: Convert Unix epoch time to normal date
...
### (79) upgrade_pipx_and_uv: Upgrade packages installed with pipx and uv
...
### (81) ut: Run unittests on a D source file
...
### (82) uv_venv: Call the `uv_venv` script
...
### (83) workspace: Identify the current workspace
...
### (84) xfce-info: Current XFCE version
...
### (85) xrates: Currency rates of HUF, EUR and USD
...
### (86) y: Start yazi (and stay in the folder where you quit)
...
### (87) zig-info: My abbreviations for zig
...
### (88) zoli: Check my friend's local time
...
## Author
* Laszlo Szathmary (jabba.laci@gmail.com), 2025--2026
